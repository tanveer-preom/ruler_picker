...
public final class RulerValuePicker extends FrameLayout implements ObservableHorizontalScrollView.ScrollChangedListener {
    ...
    private int mNotchColor = Color.GREEN;
        ...
        if (attributeSet != null) {
            ...
            try { //Parse params
                ...
                if (a.hasValue(R.styleable.RulerValuePicker_min_value) ||
                    ...
                    setMinMaxValue(Long.parseLong(a.getString(R.styleable.RulerValuePicker_min_value)),
                            Long.parseLong(a.getString(R.styleable.RulerValuePicker_max_value)));
                }
            } finally {
                a.recycle();
            }
    ...
    protected void onLayout(boolean isChanged, int left, int top, int right, int bottom) {
        ...
        futureMinutes = mRulerView.getFutureMinutes();
        Log.i("tanvvvvvv", futureMinutes+" future<<");
        if (isChanged) {
            ...
            rightParams.width = (width / 2) - (futureMinutes-2) * mRulerView.getIndicatorIntervalWidth();
    ...
    private void calculateNotchPath() {
        ...
        mNotchPath.moveTo(getWidth() / 2 - 15, 0);
        mNotchPath.lineTo(getWidth() / 2, 25);
        mNotchPath.lineTo(getWidth() / 2 + 15, 0);
        mNotchPath.moveTo(getWidth() / 2, 25);
     ...
     *              will be selected.
     */
    public void selectValue(final long value) {
    ...
    public long getCurrentValue() {
        ...
        long value = mRulerView.getMinValue() + absoluteValue * 60 * 1000L;
     ...
     * @see #getMaxValue()
     */
    public void setMinMaxValue(final long minValue, final long maxValue) {
     ...
     *n pixels. This cannot be negative number or zero.
     */
